...
public class GameMain extends JPanel implements MouseListener{
	...
	public GameMain() {   
		...
		board = new Board(); // TODO: Create a new instance of the game "Board"class. HINT check the variables above for the correct name
		
		initGame();	//TODO: call the method to initialise the game board
	...
	public static void main(String[] args) {
		...
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
	         public void run() {
				...
				GameMain gamePanel = new GameMain(); //TODO: create the new GameMain panel and add it to the frame
				frame.add(gamePanel);
				frame.setSize(CANVAS_WIDTH, CANVAS_HEIGHT);
				frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); //TODO: set the default close operation of the frame to exit_on_close
		        frame.pack();             
